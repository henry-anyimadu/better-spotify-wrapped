...
<template>
  <h3 class="font-bold text-white text-xl">Your Music Taste Rarity: {{ Math.round(popularityScore) }}%</h3>
  <br />
  <h3 class="font-bold text-white mt-8 text-xl"> <strong>Rarity</strong> is the chance that another Spotify user has a
  similar music taste to you. Artist rarity is the chance that a random Spotify user has listened to that artist recently.</h3>
